Feature: Register User
  ...
  Scenario Outline: Invalid Input
    ...
    Examples:
      ...
      | Invalid email | invalid-email | abcd1234qwer
      | Invalid password| valid@ema.il| abcd1234QWER

  Scenario: Valid Input
    Tests that the 'Register' button is enabled when valid values are provided,
    and that upon successful registration, the UI display will display the message "You've been registered successfully"
